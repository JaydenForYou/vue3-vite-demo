...
export default {
  ...
  setup() {
    ...
    const username = proxy.customStorage.getSession("userInfo") ? proxy.customStorage.getSession("userInfo").username : 'fuzzy'
    ...
    const role = computed(() => state.name === 'admin' ? '超级管理员' : '普通用户')
